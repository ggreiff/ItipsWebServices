...
namespace OppmHelper.OppmApi
{
    public class SePortfoliosPortfolio
    {
        ...
        public List<wsPortfoliosItem.psPortfoliosItemInfo> GetPortfolioListByQuery(String commonIdCategory, String portfolioScope, List<psPortfoliosQueryPart> queryPartsList, psPORTFOLIO_TYPE itemTypes)
        {
            ...
            var arScopeList = new List<psPortfoliosPortfolioIdentifier> { new psPortfoliosPortfolioIdentifier() };
        ...
        public psRETURN_VALUES RefreshDynamicPortfolio(Int32 id)
        {
            return RefreshDynamicPortfolio(id.ToString(CultureInfo.InvariantCulture));
        }

        public psRETURN_VALUES RefreshDynamicPortfolio(String id)
        {
            return RefreshDynamicPortfolio(String.Empty, id);
        }
