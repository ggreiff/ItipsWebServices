...
namespace OppmHelper.OppmApi
{
    public class SePortfoliosValueList
    {
        ...
        public wsPortfoliosValueList.psPortfoliosValueList PsValueList { get; set; }
        public wsPortfoliosValueList.psPortfoliosValueListValueInfo PValueListValueInfo { get; set; }

        public SePortfoliosValueList(SePortfolioSecurity securityLogin)
        {
            PsSecurityLogin = securityLogin;
            PsValueList = new wsPortfoliosValueList.psPortfoliosValueList { CookieContainer = PsSecurityLogin.CookieContainer };
        ...
        public List<wsPortfoliosValueList.psPortfoliosValueListValueInfo> GetValueList(String listName)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                return new List<wsPortfoliosValueList.psPortfoliosValueListValueInfo>();
            }
        }
        ...
        public void UpdateValueList(String listName, List<wsPortfoliosValueList.psPortfoliosValueListValueInfo> valueListInfos)
        {
            try
            {
